...
$page .= "\t\t<ul>\n";
$page .= "\t\t\t<li><a href=\"blog.rdf\" title=\"Get my feed into your reader :)\"><img src=\"images/banners/rss_20.png\" alt=\"RSS feed\"/></a></li>\n";
$page .= "\t\t\t<li><a href=\"blog_comments.rdf\" title=\"Get my feed with comments into your reader :)\"><img src=\"images/banners/rsscomments.gif\" alt=\"RSS feed with comments\"/></a></li>\n";
$page .= "\t\t\t<li><a href=\"marks.rdf\" title=\"Get my blogmarks into your reader :)\"><img src=\"images/banners/rss_marks.png\" alt=\"RSS feed - blogmarks\"/></a></li>\n";
$page .= "\t\t</ul>\n\t</div>\n";
...
$page .= "\t<div id=\"license\"><a href=\"" . $skel["license_uri"] . "\"><img src=\"images/banners/creativecommons.png\" alt=\"Creative Commons License\" title=\"Creative Commons: attribution, noncommercial, share alike\"/></a></div>\n";
...
$page .= "\t\t<div class=\"images\">\n";
$page .= "\t\t\t<ul>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.debian.org/\" title=\"Debian GNU/Linux\"><img src=\"images/banners/debian.png\" alt=\"Debian GNU/Linux\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.fark.com/\" title=\"Fark.com\"><img src=\"images/banners/fark.png\" alt=\"Fark.com\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://dwlt.net/tapestry/\" title=\"Tapestry comics\"><img src=\"images/banners/gotcomics.png\" alt=\"Got comics\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.deviantart.com/\" title=\"deviantART\"><img src=\"images/banners/deviantart_logo.gif\" alt=\"deviantART logo\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.scripting.com/\"><img src=\"images/banners/thanksdave.jpg\" title=\"My thanks to Dave Winer for his visionary role in the development of weblogs, RSS, podcasting, SOAP, XML-RPC, OPML, and outliners.\" alt=\"Thanks Dave\" /></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.technorati.com/profile/aquatix/3133231/41b298b8585eafc9e8c55a0b30c90f65\" title=\"My Technorati profile\"><img src=\"images/banners/technorati.gif\" alt=\"Technorati profile\"/></a></li>\n";
$page .= "\t\t\t</ul>\n";
$page .= "\t\t</div>\n";

$page .= "\t\t<div class=\"images\">\n";
$page .= "\t\t\t<ul>\n";
$page .= "\t\t\t\t<li><a href=\"http://eldred.cc/\"><img src=\"images/banners/create_like_its_1790.gif\" title=\"Save Orphan Works\" alt=\"create like it's 1790\" width=\"88\" height=\"31\" /></a></li>\n";
$page .= "\t\t\t</ul>\n";
$page .= "\t\t</div>\n";

$page .= "\t\t<div class=\"images\">\n";
$page .= "\t\t\t<ul>\n";
$page .= "\t\t\t\t<li><a href=\"index.php?page=about#browser\" title=\"Readable with Any Browser(tm)\"><img src=\"images/banners/browser_all.png\" alt=\"Optimized for all browsers\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://validator.w3.org/check/referer\" title=\"Using valid xhtml1.1\"><img src=\"images/banners/valid_xhtml11.gif\" alt=\"Valid xhtml1.1\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://jigsaw.w3.org/css-validator/check/referer\" title=\"Using valid CSS\"><img src=\"images/banners/valid_css.gif\" alt=\"Valid CSS\"/></a></li>\n";
$page .= "\t\t\t</ul>\n";
$page .= "\t\t</div>\n";

$page .= "\t\t<div class=\"images\">\n";
$page .= "\t\t\t<ul>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.catb.org/hacker-emblem/\" title=\"Solidary with white hat hacking\"><img src=\"images/banners/hacker_logo.png\" alt=\"Hacker emblem\"/></a></li>\n";
//$page .= "\t\t\t\t<li><a href=\"callto:aquatix\" title=\"Skype me! [aquatix]\"><img src=\"images/banners/skypeme.gif\" alt=\"Skype me! [aquatix]\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.mozilla.com/firefox/\" title=\"Get Firefox - Web Browsing Redefined [and take back the web]\"><img src=\"images/banners/firefox_pixel.png\" alt=\"Get Firefox\"/></a></li>\n";
$page .= "\t\t\t\t<li><a href=\"http://www.mozilla.com/thunderbird/\" title=\"Get Thunderbird and reclaim your inbox!\"><img src=\"images/banners/thunderbird_pixel.png\" alt=\"Get Thunderbird\"/></a></li>\n";
$page .= "\t\t\t</ul>\n";
$page .= "\t\t</div>\n";
