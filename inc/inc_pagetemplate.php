...
/*** Navigation part ***/
	...
	$page .= "\t\t<ul>\n";
	$page .= "\t\t\t<li><a href=\"blog.rdf\" title=\"Get my feed into your reader :)\"><img src=\"images/rss_20.png\" alt=\"RSS feed\"/></a></li>\n";
	$page .= "\t\t\t<li><a href=\"blog_comments.rdf\" title=\"Get my feed with comments into your reader :)\"><img src=\"images/rsscomments.gif\" alt=\"RSS feed with comments\"/></a></li>\n";
	$page .= "\t\t\t<li><a href=\"marks.rdf\" title=\"Get my blogmarks into your reader :)\"><img src=\"images/rss_marks.png\" alt=\"RSS feed - blogmarks\"/></a></li>\n";
	$page .= "\t\t</ul>\n\t</div>\n";
...
/*** Main content block ***/
	...
	$page .= "\t<div id=\"license\"><a href=\"" . $skel["license_uri"] . "\"><img src=\"images/creativecommons.png\" alt=\"Creative Commons License\" title=\"Creative Commons: attribution, noncommercial, share alike\"/></a></div>\n";
...
*/
	...
	$page .= "\t\t<div class=\"images\">\n";
	$page .= "\t\t\t<ul>\n";
	$page .= "\t\t\t\t<li><a href=\"http://eldred.cc/\"><img src=\"images/banners/1790.gif\" title=\"Save Orphan Works\" alt=\"create like it's 1790\" width=\"88\" height=\"31\" /></a></li>\n";
	$page .= "\t\t\t</ul>\n";
	$page .= "\t\t</div>\n";

	$page .= "\t\t<div class=\"images\">\n";
	$page .= "\t\t\t<ul>\n";
	$page .= "\t\t\t\t<li><a href=\"index.php?page=about#browser\" title=\"Readable with Any Browser(tm)\"><img src=\"images/browser_all.png\" alt=\"Optimized for all browsers\"/></a></li>\n";
	$page .= "\t\t\t\t<li><a href=\"http://validator.w3.org/check/referer\" title=\"Using valid xhtml1.1\"><img src=\"images/valid_xhtml11.gif\" alt=\"Valid xhtml1.1\"/></a></li>\n";
	$page .= "\t\t\t\t<li><a href=\"http://jigsaw.w3.org/css-validator/check/referer\" title=\"Using valid CSS\"><img src=\"images/valid_css.gif\" alt=\"Valid CSS\"/></a></li>\n";
	$page .= "\t\t\t</ul>\n";
	$page .= "\t\t</div>\n";

	$page .= "\t\t<div class=\"images\">\n";
	$page .= "\t\t\t<ul>\n";
	$page .= "\t\t\t\t<li><a href=\"http://www.catb.org/hacker-emblem/\" title=\"Solidary with white hat hacking\"><img src=\"images/hacker_logo.png\" alt=\"Hacker emblem\"/></a></li>\n";
	//$page .= "\t\t\t\t<li><a href=\"callto:aquatix\" title=\"Skype me! [aquatix]\"><img src=\"images/skypeme.gif\" alt=\"Skype me! [aquatix]\"/></a></li>\n";
	$page .= "\t\t\t\t<li><a href=\"http://www.mozilla.com/firefox/\" title=\"Get Firefox - Web Browsing Redefined [and take back the web]\"><img src=\"images/firefox_pixel.png\" alt=\"Get Firefox\"/></a></li>\n";
	$page .= "\t\t\t\t<li><a href=\"http://www.mozilla.com/thunderbird/\" title=\"Get Thunderbird and reclaim your inbox!\"><img src=\"images/thunderbird_pixel.png\" alt=\"Get Thunderbird\"/></a></li>\n";
	$page .= "\t\t\t</ul>\n";
	$page .= "\t\t</div>\n";
