...
$skel['license_text'] = '<span class="license"><abbr title="Creative Commons Attribution-NonCommercial-ShareAlike 3.0">&#128326;&#128327;&#128330;</abbr></span> License</a>';
...
} else if ((date('m') == 6 && date('d') > 20) || (date('m') < 10))
{
	...
	$skel['logo'] = 'img/header_butterfly.jpg';
