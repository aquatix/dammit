...
function buildPage($skel, $section_name, $page_name, $page_body)
{
	...
	//$page .= "<base href=\"" . $skel['base_server'] . $skel['base_uri'] . "\"/>\n";
	...
	//$page .= "<meta name=\"author\" link=\"" . $skel['base_uri'] . "about.php\" title=\"Michiel Scholten\"/>\n";
	...
	$page .= "\t<div id=\"footer\">[ Valid <a href=\"http://validator.w3.org/check/referer\">XHTML 1.0</a> | &copy; " . $skel['startyear'] . "-" . date('Y') . " <a href=\"" . $skel['base_uri'] . "p/about\">" . $skel['author'] . "</a> under a <a href=\"" . $skel['license_uri'] . "\"><acronym title=\"Creative Commons\">CC</acronym> License</a> ]</div>\n";
